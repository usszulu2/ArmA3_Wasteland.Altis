...
[
/*
Put the UID of donators here. The UID must be in quotes and must end in with a comma (,) except for the last entry.
Example
"123456787654321", //Billy Bob
"112233445566778" //NotBillyBob
*/
"123456787654321", //Billy Bob
"112233445566778"  //NotBillyBob
];
...
for [{_i=0}, {_i < count donatorsArray}, {_i=_i+1}] do 
	{
	if (donatorsArray select _i == _uid) then 
		{
		_isDonator = true;
		//exitWith{};
		};
...
if (!_isDonator) then //Non donator items go here
{
