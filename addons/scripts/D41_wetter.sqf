		...
		if (isDedicated) then
			{
				...
				if(D41_ChanceN >=8 && D41_ChanceN <= 23 && D41_RegenCounter == 0) then
					{
						...
						if(D41_WMod == 4)	then {D41_Nebel = 0.1;	D41_Wellen = 1;		D41_Vorschau = 0.7; D41_Wind = [6, 0, true];	D41_Regen = 0.3; D41_Blitze = 1;};
						...
						if(D41_WMod == 7)	then {D41_Nebel = 0.1;	D41_Wellen = 1;		D41_Vorschau = 0.6; D41_Wind = [2, 4, true];	D41_Regen = 0.2; D41_Blitze = 0;};
						if(D41_WMod == 8)	then {D41_Nebel = 0.1;	D41_Wellen = 1;		D41_Vorschau = 0.5; D41_Wind = [3, 2, true];	D41_Regen = 0.2; D41_Blitze = 0;};
