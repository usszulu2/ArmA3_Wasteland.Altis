...
boomerang_min_distance = 100; //minimum distance from the base station for terminals to work
boomerang_vehicle_class_list = ["All"]; //list of vehicle classes where boomerang can be deployed
...
MF_ITEMS_BOOMERANG_TERMINAL_ICON = "addons\boomerang\icons\terminal.paa";

//Station
MF_ITEMS_BOOMERANG_STATION = "boomerang_station";
MF_ITEMS_BOOMERANG_STATION_TYPE = "Land_SatellitePhone_F";
MF_ITEMS_BOOMERANG_STATION_ICON = "addons\boomerang\icons\antenna.paa";
