...
class cctv_menu {
	...
	class cctv_menu_header : gui_RscMenuTitle {
	...
	class cctv_menu_background: gui_Rscbackground {
	...
	//Camera name
	class cctv_menu_camera_name_label : gui_RscText {
	...
	class cctv_menu_camera_name_field: gui_RscEdit {
	...
	//Access Type
	class cctv_menu_access_control_label : gui_RscText {
	...
	class cctv_menu_access_control_field : gui_RscCombo {
	...
	//Buttons
	class cctv_menu_button_ok : gui_RscMenuButton {
	...
	class cctv_menu_button_cancel : gui_RscMenuButton {
