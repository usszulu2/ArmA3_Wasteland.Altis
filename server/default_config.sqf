...
A3W_disableSideVoice = 1;          // Auto-switch channel to Direct communication whenever broadcasting voice on side, unless being admin (0 = no, 1 = block Ind team, 2 = block all teams)
